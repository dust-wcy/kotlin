...
public class KotlinCompilerConfigurableTab implements SearchableConfigurable, Configurable.NoScroll{
    ...
    public boolean isModified() {
        return isModified(reportWarningsCheckBox, !commonCompilerArguments.getSuppressWarnings()) ||
               ...
               (compilerWorkspaceSettings != null &&
                (isModified(enableIncrementalCompilationForJvmCheckBox, compilerWorkspaceSettings.getIncrementalCompilationForJvmEnabled()) ||
    ...
    public void applyTo(
        ...
        if (compilerWorkspaceSettings != null) {
            compilerWorkspaceSettings.setIncrementalCompilationForJvmEnabled(enableIncrementalCompilationForJvmCheckBox.isSelected());
    ...
    public void reset() {
        ...
        if (compilerWorkspaceSettings != null) {
            enableIncrementalCompilationForJvmCheckBox.setSelected(compilerWorkspaceSettings.getIncrementalCompilationForJvmEnabled());
